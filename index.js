...
async function selectLevelAndLocation(page) {
  ...
  const locationDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[1]'
  );
  await locationDropdown.click();
  await page.waitForTimeout(500);

  // SELECT LOCATION ✅
  //!! choices--location-item-choice-2 = Jakarta
  //!! choices--location-item-choice-5 = Medan
  const locationSelect = await page.waitForXPath(
    '//*[@id="choices--location-item-choice-2"]'
  );
  await locationSelect.click();
  await page.waitForTimeout(800);

  // CLICK LEVEL DROPDOWN ✅
  const levelDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[3]/div/div[1]'
  );
  await levelDropdown.click();
  await page.waitForTimeout(500);

  // SELECT LEVEL ✅
  //!! choices--grade-item-choice-5 = N4
  //!! choices--grade-item-choice-4 = N3
  const levelSelect = await page.waitForXPath(
    '//*[@id="choices--grade-item-choice-5"]'
  );
  await levelSelect.click();
  await page.waitForTimeout(800);

  // CLICK FILTERED TEST ROW ✅
  const buttonN3 = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[4]/div/table/tbody/tr/td[6]/a'
  );
...
async function fillRegistrationForm(page) {
  ...
  const modal1Button = await page.waitForXPath(
    '//*[@id="modal-alert"]/div/div/div/div[3]/button'
  );
  ...
  const [fileChooser] = await Promise.all([
    ...
    page.click(
      "#userApp > section > div > div > div:nth-child(2) > div > div.col-lg-2.mb-4.mb-lg-0 > div.d-grid"
    ),
  ]);
  ...
  const modal2Button = await page.waitForXPath(
    '//*[@id="modal-alert"]/div/div/div/div[3]/button'
  );
  ...
  const cropButton = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[1]/div[2]/button'
  );
  ...
  const genderDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[1]/div[3]/div/div[1]'
  );
  await genderDropdown.click();
  await page.waitForTimeout(500);

  // SELECT "JENIS KELAMIN" ✅
  const genderSelect = await page.waitForXPath(
    '//*[@id="choices--jenis_kelamin-item-choice-1"]'
  );
  await genderSelect.click();
  await page.waitForTimeout(800);

  // CLICK "BAHASA UTAMA" DROPDOWN ✅
  const mainLangDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[1]/div[4]/div/div[1]'
  );
  await mainLangDropdown.click();
  await page.waitForTimeout(500);

  // SELECT "BAHASA UTAMA" ✅
  const mainLangSelect = await page.waitForXPath(
    '//*[@id="choices--bahasa-item-choice-10"]'
  );
  ...
  const provinceDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[1]/div[6]/div/div[1]'
  );
  await provinceDropdown.click();
  await page.waitForTimeout(500);

  // SELECT "PROVINSI" ✅
  const provinceSelect = await page.waitForXPath(
    '//*[@id="choices--provinsi-item-choice-9"]'
  );
  await provinceSelect.click();
  await page.waitForTimeout(800);

  // CLICK "KOTA" DROPDOWN ✅
  const cityDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[1]/div[7]/div/div[1]'
  );
  await cityDropdown.click();
  await page.waitForTimeout(500);

  // SELECT "KOTA" ✅
  const citySelect = await page.waitForXPath(
    '//*[@id="choices--city-item-choice-24"]'
  );
  ...
  const learnLocDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[2]/div[1]/div/div[1]'
  );
  await learnLocDropdown.click();
  await page.waitForTimeout(500);

  // SELECT "TEMPAT BELAJAR BAHASA JEPANG" ✅
  const learnLocSelect = await page.waitForXPath(
    '//*[@id="choices--course_place-item-choice-4"]'
  );
  await learnLocSelect.click();
  await page.waitForTimeout(800);

  // CLICK "ALASAN MENGIKUTI UJIAN" DROPDOWN ✅
  const reasonDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[2]/div[2]/div/div[1]'
  );
  await reasonDropdown.click();
  await page.waitForTimeout(500);

  // SELECT "ALASAN MENGIKUTI UJIAN" ✅
  const reasonSelect = await page.waitForXPath(
    '//*[@id="choices--reason-item-choice-6"]'
  );
  await reasonSelect.click();
  await page.waitForTimeout(800);

  // CLICK "PEKERJAAN" DROPDOWN ✅
  const professionDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[2]/div[3]/div/div[1]'
  );
  await professionDropdown.click();
  await page.waitForTimeout(500);

  // SELECT "PEKERJAAN" ✅
  const professionSelect = await page.waitForXPath(
    '//*[@id="choices--profession-item-choice-5"]'
  );
  await professionSelect.click();
  await page.waitForTimeout(800);

  // CLICK "DETAIL PEKERJAAN" DROPDOWN ✅
  const detailProfessionDropdown = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[2]/div[4]/div/div[1]'
  );
  await detailProfessionDropdown.click();
  await page.waitForTimeout(500);

  // SELECT "DETAIL PEKERJAAN" ✅
  const detailProfessionSelect = await page.waitForXPath(
    '//*[@id="choices--use-item-choice-3"]'
  );
  ...
  const submit1Button = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[2]/div/div[2]/div[7]/div[3]/div/button'
  );
  await submit1Button.click(); // CLICK FOR CONFIRM
  await page.waitForTimeout(1500);

  const submit2Button = await page.waitForXPath(
    '//*[@id="userApp"]/section/div/div/div[3]/div/div[2]/div[7]/div[3]/div/button'
  );
  await submit2Button.click(); // CLICK FOR SUBMIT
  await page.waitForTimeout(1000);

  // CLOSE "KUOTA ANDA AKAN HANGUS" MODAL ✅
  const modalToPaymentButton = await page.waitForXPath(
    '//*[@id="menuju-pembayaran"]/div/div/div/div[3]/button[2]'
  );
...
async function selectPaymentMethod(page) {
  ...
  // SELECT "GOPAY METHOD" ✅
  const selectGopay = await page.waitForXPath(
    '//*[@id="list-pembayaran"]/div/div/div[3]/div[6]/label'
  );
  ...
  const payButton = await page.waitForXPath(
    '//*[@id="list-pembayaran"]/div/div/div[4]/button'
  );
